...
save "meningitis_ADMN2_full_outbreak_list.dta", replace
...
gen  Weekstring = string(WEEK)
gen merge_code = district_country + " " + Yearstring + " " + Weekstring


sort district_country
sort merge_code
save "full-outbreak-clean.dta", replace


import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\INLA project\Shapefile_spatiotemporal_2003.csv", clear 
gen  Yearstring = string(year)
gen  Weekstring = string(week)

gen district_country = name_2 + " " + country

gen merge_code = district_country + " " + Yearstring + " " + Weekstring

sort merge_code
merge merge_code using "full-outbreak-clean.dta"
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2003.dta", replace



clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\INLA project\Shapefile_spatiotemporal_2004.csv", clear 
gen  Yearstring = string(year)
gen  Weekstring = string(week)
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2004.dta", replace


clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\INLA project\Shapefile_spatiotemporal_2005.csv", clear 
gen  Yearstring = string(year)
gen  Weekstring = string(week)
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2005.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\INLA project\Shapefile_spatiotemporal_2006.csv", clear 
gen  Yearstring = string(year)
gen  Weekstring = string(week)
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2006.dta", replace



clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2007.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2007.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2008.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2008.dta", replace



clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2009.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2009.dta", replace



clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2010.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2010.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2011.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2011.dta", replace




clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2012.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2012.dta", replace




clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2013.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2013.dta", replace



clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2014.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2014.dta", replace




clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2015.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2015.dta", replace



clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2016.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2016.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2017.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2017.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2018.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2018.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2019.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2019.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2020.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2020.dta", replace




clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2021.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2021.dta", replace
...
clear
import delimited "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\Climate_meningitis_belt\Shapefile_spatiotemporal_2022.csv", clear 
...
tab _merge
drop if _merge == 2
save "spatiotemporaloutbreak2022.dta", replace


append using spatiotemporaloutbreak2003 spatiotemporaloutbreak2004 spatiotemporaloutbreak2005 spatiotemporaloutbreak2006 spatiotemporaloutbreak2007 spatiotemporaloutbreak2008 spatiotemporaloutbreak2009 spatiotemporaloutbreak2010 spatiotemporaloutbreak2011 spatiotemporaloutbreak2012 spatiotemporaloutbreak2013 spatiotemporaloutbreak2014 spatiotemporaloutbreak2015 spatiotemporaloutbreak2016 spatiotemporaloutbreak2017 spatiotemporaloutbreak2018 spatiotemporaloutbreak2019 spatiotemporaloutbreak2020 spatiotemporaloutbreak2021 spatiotemporaloutbreak2022

gen outbreak = 0
replace outbreak = 1 if _merge == 3
...
export delimited using "C:\Users\mvc32\OneDrive - University of Cambridge\Documents\INLA project\full-outbreak-matched.csv"
